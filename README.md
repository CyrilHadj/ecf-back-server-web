...
```sql
# Ecrivez la requête ici ...
INSERT INTO product_panier(product_id,panier_id,quantity) VALUES (2,1,23);
```
...
```sql
# Ecrivez la requête ici ...
INSERT INTO commande (panier_id,employe_id,isvalide) VALUES (1,1,1);
```
...
```sql
# Ecrivez la requête ici ...
INSERT INTO product (name,price) VALUES ("DoubleBigMassi", 10);
```
...
```sql
# Ecrivez la requête ici ...
SELECT * FROM product NATURAL JOIN panier WHERE panier.client_id = 2;
```
